...
if __name__ == "__main__":
    ...
    # --- TEST PHASE ---
    print("\n" + "=" * 60)
    print("PHASE 2: TEST BLOCKING")
    print("=" * 60)

    test_db = setup_db("test_blocking.db")

    index_source_files(test_db, [os.path.join(TEST_DIR, "test_source2.tsv")], "S2")
    index_source_files(test_db, [os.path.join(TEST_DIR, "test_source3.tsv")], "S3")

    analyze_block_sizes(test_db)
    ...
    print("\n✅ DONE! Check output/candidate_pairs.tsv")